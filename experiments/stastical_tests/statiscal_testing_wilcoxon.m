...
% Combine Median and IQR values for Model 1
m1_median_iqr_values = [median(m1_snr_00_mae_values), median(m1_snr_05_mae_values), median(m1_snr_10_mae_values), median(m1_snr_15_mae_values); ...
                        iqr(m1_snr_00_mae_values), iqr(m1_snr_05_mae_values), iqr(m1_snr_10_mae_values), iqr(m1_snr_15_mae_values)]';

% Combine Median and IQR values for Model 2
m2_median_iqr_values = [median(m2_snr_00_mae_values), median(m2_snr_05_mae_values), median(m2_snr_10_mae_values), median(m2_snr_15_mae_values); ...
                        iqr(m2_snr_00_mae_values), iqr(m2_snr_05_mae_values), iqr(m2_snr_10_mae_values), iqr(m2_snr_15_mae_values)]';

% Format Median and IQR values to 3 decimals
m1_median_iqr_values_formatted = arrayfun(@(x) sprintf('%.3f', x), m1_median_iqr_values, 'UniformOutput', false);
m2_median_iqr_values_formatted = arrayfun(@(x) sprintf('%.3f', x), m2_median_iqr_values, 'UniformOutput', false);

% Combine p-values and Median/IQR values into one table
T_combined = table(snr_levels', p_values_formatted, m1_median_iqr_values_formatted(:,1), m1_median_iqr_values_formatted(:,2), ...
                   m2_median_iqr_values_formatted(:,1), m2_median_iqr_values_formatted(:,2), ...
                   'VariableNames', {'SNR', 'P_Value', 'Model1_Median_MAE', 'Model1_IQR_MAE', 'Model2_Median_MAE', 'Model2_IQR_MAE'});
...
writetable(T_combined, 'NEW_results_wilcoxon_af_comp.txt');
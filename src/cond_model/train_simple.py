...
from model_SR3 import GaussianDiffusion
...
# ****************************************************************************************************************************
# ****************************************************************************************************************************
# STEP 2: Initialize Diffusion Model and Denoising Function             # TODO: add this shit later to a config file...

print('Status: Loading Diffusion Model')
...
# Attempt to use this schedule: https://github.com/Janspiry/Image-Super-Resolution-via-Iterative-Refinement/blob/master/config/sr_sr3_16_128.json
# config_diff = {
#     'beta_start':  1e-6,
#     'beta_end': 1e-2,
#     'num_steps': 2000,
...
config_diff = {
    'beta_start':  0.0001,
    'beta_end':  0.02,
    'num_steps': 1000,  # Reduced number of steps
    'schedule': "linear"
}

print('Status: Initializing the Denoising Function')
# Define model parameters
in_channels=6  # Concat x_noisy and y_in results 2 (*3) RGB = 6
out_channels=3  #  RGB
inner_channels = 12     # Depth feature maps, model complexity 
norm_groups = 12    #  Granularity of normalization, impacting convergence
...
# Training Configuartion (Modified)
config_train = { 
    'feats':20,
    'epochs':1,
    'batch_size':32,

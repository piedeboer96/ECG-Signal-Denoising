...
data_HR = load('results/ardb/EM/m1_em_snr_3/sig_HR.mat');
sig_HR = data_HR.sig_HR; 

% Load the noisy signal
data_SR = load('results/ardb/EM/m1_em_snr_3/sig_SR.mat');
sig_SR = data_SR.sig_SR; 

% Load denoised signal from SR3
data_rec = load('results/ardb/EM/m1_em_snr_3/sig_rec.mat');
...
% Wavelet Denoising
% sig_wavelet = wdenoise(sig_SR, 'Wavelet', 'sym6', 'DenoisingMethod', 'Bayes', 'ThresholdRule', 'Soft'); % Paper 2020 (Review of noise removal techniques in ECG signals)
sig_wavelet = wdenoise(sig_SR, 'Wavelet', 'sym5'); % Paper 2020 (Review of noise removal techniques in ECG signals)
